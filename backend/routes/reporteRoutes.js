...
router.get('/reportes/:id_reporte', reporteController.getReportesById);
router.get('/reportes/:id_cliente', reporteController.getReportesByCliente);
router.get('/reportes/:tipo_reporte', reporteController.getReportesByType);
